...
<body>
    ...
    <div style="padding-top: 15px; font-size: 15px;">
      ...
      <table style="padding-top: 30px;">
        <tr>
          ...
          <td style="width: 40%; font-size: 15px; position: relative;">
            <img src="./ttd/stempel.png" alt="Stempel" style="position: absolute; top: 10; left: -20; width: 120px">
            <img src="./ttd/kepsek.png" alt="TTD Kepsek" style="position: absolute; top: 30; left: 0; height: 70px">
            {{$bagiraport->tempatbagiraport ?? 'Tempat'}}, {{ Carbon::createFromFormat('Y-m-d', Str::before($bagiraport->tanggalbagiraport, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal'}}, <br>
            Kepala Sekolah, <br><br><br><br>
            <b><u>{{$sekolah->kepsek}}</u></b><br>
            NIP. {{$sekolah->nipkepsek}}
  ...
  <div class="invoice-box">
    ...
    <div style="position: relative; padding-left:60%; padding-top:1rem; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;">
      <img src="./ttd/{{ $siswa->kelas->ttd }}" alt="TTD Wali Kelas" style="position: absolute; top: 30; right: 0: ; height: 70px">
      {{$bagiraport->tempatbagiraport ?? 'Tempat'}}, {{ Carbon::createFromFormat('Y-m-d', Str::before($bagiraport->tanggalbagiraport, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal'}}, <br>
  ...
  <div class="invoice-box">
    ...
    <div class="content">
      <table cellspacing="0">
        ...
        <tr class="sikap">
          <td colspan="4" class="description" style="height: 45px;">
            @if ($siswa->kelas->tingkat != 12)
            Berdasarkan hasil yang dicapai pada semester 1 dan 2, Peserta didik ditetapkan : <br>
            <b>
              @if($siswa->kelas->tingkat == 10)
              TINGGAL DI KELAS 10 (SEPULUH) / NAIK KE KELAS 11 (SEBELAS)
              @elseif ($siswa->kelas->tingkat == 11)
              TINGGAL DI KELAS 11 (SEBELAS) / NAIK KE KELAS 12 (DUABELAS)
              @else
              LULUS / TIDAK LULUS
              @endif
            </b>
            @elseif($siswa->kelas->tingkat == 12)
      ...
      <table>
        <tr>
          ...
          <td style="width: 35%; position: relative">
            <img src="./ttd/{{ $siswa->kelas->ttd }}" alt="TTD Wali Kelas" style="position: absolute; top: 20; right: 0: ; height: 70px">
            {{$bagiraport->tempatbagiraport ?? 'Tempat'}}, {{ Carbon::createFromFormat('Y-m-d', Str::before($bagiraport->tanggalbagiraport, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal'}}, <br>
            Wali Kelas, <br><br><br><br>
            <b><u>{{$siswa->kelas->guru->name}}, {{$siswa->kelas->guru->gelar}}</u></b><br>
            NIP. {{$siswa->kelas->guru->nip}}
        ...
        <tr>
          ...
          <td style="width: 35%; position: relative;">
            <img src="./ttd/stempel.png" alt="Stempel" style="position: absolute; top: 5; left: -20; width: 120px">
            <img src="./ttd/kepsek.png" alt="TTD Kepsek" style="position: absolute; top: 20; left: 0; height: 70px">
            Mengetahui <br>
            Kepala Sekolah, <br><br><br><br>
            <b><u>{{$sekolah->kepsek}}</u></b><br>
            NIP. {{$sekolah->nipkepsek}}
