                    ...
                    <div class="col">
                        <div class="row ">
                          ...
                          @if (Auth::user()->role === 'siswa' || Auth::user()->role === 'walisiswa')
                            ...
                            <div class="col-md-6 col-sm-4 col-6">
                                <form action="{{ route('dashboard.index', $role) }}" method="GET">
                            ...
                            <div class="card mb-4 mt-3">
                                <div class="card-header">
                                    <h3 class="card-title">Nilai Rata-rata Siswa (Semester {{ $semester }})</h3>
                                </div>
                                <div class="card-body">
  ...
  <div class="modal fade" id="addInformasi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <script>
        var options = {
            ...
            series: [{
                name: 'Nilai Akhir',
                data: @json(array_column($chartData, 'nilai_akhir'))
            }],
            xaxis: {
                categories: @json(array_column($chartData, 'mapel'))
            },
            yaxis: {
                max: 100
            }
