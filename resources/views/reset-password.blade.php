    ...
    <section class="h-100 w-100" style="box-sizing: border-box;">
                    ...
                    <div class="right mx-lg-0 mx-auto">
                        ...
                        <form style="margin-top: 1.5rem" action="{{ route('login') }}" method="POST">
                            ...
                            <div style="margin-top: 1rem">
                                <label for="password1" class="d-block input-label">New Password</label>
                                <div class="d-flex w-100 div-input">
                                    ...
                                    <div onclick="togglePassword('password1', 'icon-toggle1')" style="cursor: pointer;">
                                        <svg style="margin-left: 0.75rem;" width="20" height="14"
                            ...
                            <div style="margin-top: 1rem">
                                <label for="password2" class="d-block input-label">Confirm Password</label>
                                <div class="d-flex w-100 div-input">
                                    <svg class="icon" style="margin-right: 1rem" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <input class="input-field border-0" type="password" name="password2" id="password2"
                                        placeholder="Ulangi password Baru" required />
                                    <div onclick="togglePassword('password2', 'icon-toggle2')" style="cursor: pointer;">
                                        <svg style="margin-left: 0.75rem;" width="20" height="14"
                                            viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <script>
            function togglePassword(passwordId, iconId) {
                ...
                var iconToggle = document.getElementById(iconId);
                if (passwordField.type === "password") {
                    passwordField.type = "text";
                    iconToggle.setAttribute("fill", "#2ec49c");
                } else {
